async function get_details() {
    const main_data = await fetch("https://611f26339771bf001785c726.mockapi.io/users");
  ...
  function user_details(data) {
    ...
    <p class="details"><strong>Date Joined: </strong>${new Date(data.createdAt).toDateString()}</p>
